...
const githubParser = makeValidator((input) => {
...
const oktaParser = makeValidator((input) => {
...
const cloudinaryParser = makeValidator((input) => {
...
const slackParser = makeValidator((input) => {
